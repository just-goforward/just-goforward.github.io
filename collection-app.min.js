...
<div class="metric"><span>SR 15 도달 확률</span><strong>${formatPercent(best.successProbability, 2)}</strong></div>
...
<div>
<dt>기대 소모량</dt>
<dd>${vectorCells(best.vector)}. 현재 정책을 SR 15 도달 또는 보유 키트 소진까지 따른다고 볼 때의 확률 가중 평균입니다.</dd>
</div>
<div>
<dt>계산 방식</dt>

...
function chooseEfficientCandidate(candidates, maxSuccessProbability) {
...
return compareEfficiency(candidate, best) < 0 ? candidate : best;
}, null);
}
function compareByStrategy(a, b, maxSuccessProbability) {
...
if (aEligible && bEligible) return compareEfficiency(a, b);
...
const best = chooseEfficientCandidate(candidates, maxSuccessProbability);
memo.set(key, best);
...
.filter(Boolean)
.sort((a, b) => compareByStrategy(a, b, mdp.maxSuccessProbability));

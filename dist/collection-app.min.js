...
<div>
<dt>계산 방식</dt>
<dd>보유 키트 사용 가능 횟수를 상태에 포함한 유한 MDP입니다. 정확한 최대 SR 15 도달 확률에서 ${formatPercentagePoint(result.stats.probabilityTolerance || 0, 1)} 이내인 후보만 남긴 뒤, 보유량 압박과 기대 소모가 낮은 행동을 선택합니다. 확률 전이는 정확 계산이며 반복 수렴 허용오차는 0입니다.</dd>
</div>
</dl>

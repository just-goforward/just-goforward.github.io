...
${difficultyList(stats.segmentStats || [])}
</section>
</div>
</div>
`;
...
<span class="difficulty-segment">${item.label}</span>
...
<span>이론 ${attempts ? formatPercent(theoreticalRate, 1) : "-"}</span>
</div>
